    ...
    <div class="container">
        <div class="row mt-5 justify-content-center">
            <div class="col-10">
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        <h1 class="mt-2 mb-3">Form Edit kandidat</h1>
                        <form action="/kandidat/{{$kandidat->id}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="user_id" class="form-select" required>
                                    ...
                                    @foreach ($studentAll as $data)
                                        <option @if($kandidat->user_id == $data->id) selected @endif value="{{$data->id}}">{{$data->name}} - {{$data->classroom->name}} - {{$data->jurusan->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                <label>Visi</label>
                                <input type="text" name="visi" value="{{$kandidat->visi}}" required class="form-control @error('visi') is-invalid @enderror">
